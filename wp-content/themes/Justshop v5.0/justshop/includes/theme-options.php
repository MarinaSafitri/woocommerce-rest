...
if ( $settings13['rmve_import'] == 'false' ) {
	...
	$options[] = array(
		...
		'std'  => sprintf( __( 'Please %1$s (or go to Tools->Import) & click WordPress (install importer plugin if prompted) and import Your-themeforest-download/resources/import-data/content.xml file. (Check box to import attachments during process). This process can take upto 3 mins.', 'templatation' ), '<a href="' . esc_url( home_url() ) . '/wp-admin/import.php">' . __( 'click here', 'templatation' ) . '</a>' ),
		'type' => 'info',
		'class' => 'hidden',
	);
