...
function templatation_testimonials ( $args = '' ) {
	...
	($args['before'] == 'false') ? $args['before'] = '<div class="widget testi_slide widget_templatation_testimonials">' : $args['before'] = '<div class="widget widget_templatation_testimonials">'; // .inner class is being hooked to .testi_slide
